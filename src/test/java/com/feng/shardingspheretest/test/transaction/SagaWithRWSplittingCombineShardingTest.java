...
import com.feng.shardingspheretest.service.SagaTransactionService;
import org.junit.*;
...
public class SagaWithRWSplittingCombineShardingTest {
    ...
    // bug here
    // 4.0.0-RC2版本
    // sharding-sphere使用了saga思想，在底层sharding-sphere自动生成反向补偿SQL，因此要求插入操作必须包含主键信息（配置由sharding-jdbc生成主键也可以）。
