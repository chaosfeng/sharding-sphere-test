...
public class ComplexShardingTest {
    ...
    public void queryOrderByUserIdAndOrderIdTest() {
        List<Order> orderList11 = orderService.getByUserIdAndOrderId(0, 0);// 应查询master0的t_order_0
        ...
        List<Order> orderList21 = orderService.getByUserIdAndOrderId(1, 0);// 应查询master0的t_order_1
        ...
        List<Order> orderList31 = orderService.getByUserIdAndOrderId(0, 1);// 应查询master1的t_order_0
        ...
        List<Order> orderList41 = orderService.getByUserIdAndOrderId(1, 1);// 应查询master1的t_order_1
