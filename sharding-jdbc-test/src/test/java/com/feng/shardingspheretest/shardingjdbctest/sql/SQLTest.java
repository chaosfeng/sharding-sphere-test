package com.feng.shardingspheretest.shardingjdbctest.sql;

import com.feng.shardingspheretest.shardingjdbctest.domain.Order;
import com.feng.shardingspheretest.shardingjdbctest.mapper.SqlTestMapper;
...
import com.feng.shardingspheretest.shardingjdbctest.service.UserService;
import org.junit.*;
...
public class SQLTest {
    ...
    @Test
    public void testSQL0_initDataForTest() {
        // 插入用户，共4个表，每个表2条数据
        //master0.t_user_0
    ...
    public void testSQL5_join() {
        ...
        userService.add(50,50, "com/feng/shardingjdbctest");
        // 错误
